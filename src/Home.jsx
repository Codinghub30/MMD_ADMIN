  ...
  useEffect(() => {
    ...
    const fetchOverdueCount = async () => {
      try {
        ...
        setOverdueCount(
          response.data.data.overdueFollowUps
            ? response.data.data.overdueFollowUps
            : 0
        );
      } catch (error) {
  ...
  useEffect(() => {
    ...
    const fetchDeadCount = async () => {
      try {
        ...
        setdeadCount(
          response.data.data.deadLeads ? response.data.data.deadLeads : 0
        );
      } catch (error) {
        console.error("Error fetching dead count:", error);
      }
  ...
  useEffect(() => {
    ...
    const fetchFollowUpCount = async () => {
      ...
      try {
        ...
        setfollowupcount(
          response.data.data.followups ? response.data.data.followups : 0
        );
  ...
  useEffect(() => {
    ...
    const fetchConvertedCount = async () => {
      try {
        ...
        setconvertedcount(
          response.data.data.convertedLeads
            ? response.data.data.convertedLeads
            : 0
        );
      } catch (error) {
  ...
  useEffect(() => {
    ...
    const fetchCount = async () => {
      try {
        ...
        settotalCount(
          response.data.data.totalLeads ? response.data.data.totalLeads : 0
        );
      } catch (error) {
  ...
  useEffect(() => {
    ...
    const fetchInprocessCount = async () => {
      try {
        ...
        setinprocesscount(
          response.data.data.inProgressLeads
            ? response.data.data.inProgressLeads
            : 0
        );
      } catch (error) {
  ...
  useEffect(() => {
    ...
    const fetchTodayCount = async () => {
      try {
        ...
        settodaysfollowupcount(
          response.data.data.todayFollowUps
            ? response.data.data.todayFollowUps
            : 0
        );
      } catch (error) {
        ...
        >
          ...
          >
            ...
            >
              <h1
                className="card-number"
                style={{ color: "white", margin: "auto", fontSize: "40px" }}
              >
                {overdueCount}
              </h1>
              <div className="card-footer" style={{ color: "white" }}>
